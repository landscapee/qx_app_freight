...
//            } else {
//                NotifiationUtil.showNotification(context, groupName + "-" + friendName + ":" + receiveMessage, groupName, friendName + ":" + receiveMessage, Constant.NOTIFY_ID_CHAT, R.raw.im_notice, newIntent);
//            }
//        } else {
//            newIntent = IMLIBContext.getInstance().getPersonalChatIntent(context, friendImid, friendName, receiveImid);
//            NotifiationUtil.showNotification(context, friendName + ":" + receiveMessage, friendName, receiveMessage, Constant.NOTIFY_ID_CHAT, R.raw.im_notice, newIntent);
//        }
    }
}
