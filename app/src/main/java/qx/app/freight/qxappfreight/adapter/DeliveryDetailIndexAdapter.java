...
public class DeliveryDetailIndexAdapter extends BaseQuickAdapter<WaybillsBean, BaseViewHolder> {
    private DeliveryDetailInterface listener;
    public DeliveryDetailIndexAdapter(@Nullable List<WaybillsBean> data) {
        super(R.layout.item_delivery_index_detail, data);
    }
