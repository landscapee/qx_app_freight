...
public class GetWayBillInfoByIdDataModel extends BaseModel implements GetWayBillInfoByIdDataContract.getWayBillInfoByIdDataModel {
    @Override
    public void getWayBillInfoByCode(String waybillCode, IResultLisenter lisenter) {
        Disposable subscription = UpdateRepository.getInstance().getWayBillInfoByCode(waybillCode)
