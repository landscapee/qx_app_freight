...
public class CargoManifestAdapter extends BaseQuickAdapter<TransportDataBase, BaseViewHolder> {

    public CargoManifestAdapter(List<TransportDataBase> list) {
        super(R.layout.item_task_cargo_manifest, list);
    }
