...
public class ClearStorageAdapter extends BaseQuickAdapter<InventoryQueryBean.RecordsBean, BaseViewHolder> {

    public ClearStorageAdapter(@Nullable List<InventoryQueryBean.RecordsBean> list) {
