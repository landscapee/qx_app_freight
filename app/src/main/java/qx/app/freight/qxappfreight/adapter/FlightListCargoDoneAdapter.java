...
public class FlightListCargoDoneAdapter extends BaseQuickAdapter<TransportTodoListBean, BaseViewHolder> {
    public FlightListCargoDoneAdapter(@Nullable List<TransportTodoListBean> data) {
