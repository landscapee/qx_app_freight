...
public class GetFlightCargoResPresenter extends BasePresenter {
    ...
    public void getFlightCargoRes(String id) {
        ...
        ((GetFlightCargoResModel) mRequestModel).getFlightCargoRes(id, new IResultLisenter<List<GetFlightCargoResBean>>() {
            @Override
            public void onSuccess(List<GetFlightCargoResBean> getFlightCargoResBeans) {
