...
public class TaskStowageAdapter extends BaseQuickAdapter<TransportDataBase, BaseViewHolder> {
    public TaskStowageAdapter(List<TransportDataBase> list) {
    ...
    protected void convert(BaseViewHolder helper, TransportDataBase item) {
        ...
        helper.setText(R.id.tv_waybill_count,"运单件数"+item.getTotalNumber());
    }
}
